...
Route::middleware('admin.access')->prefix('admin')->name('admin.')->group(function (): void {
    ...
    Route::get('/users/{user}/delete', [UserController::class, 'deleteConfirm'])->name('users.delete-confirm');
    ...
    Route::get('/settings/operations', [SettingsController::class, 'operations'])->name('settings.operations');
